...
contract InitDiamond {
    ...
    function init(Args memory _args) external {
        ...
        // s.itemsBaseUri = "https://generatxor.com/metadata/items/";
        // s.childChainManager = _args.childChainManager;

        // s.domainSeparator = LibMeta.domainSeparator("GeneratxorDiamond", "V1");
        ...
        // s.gxorContract = _args.gxorContract;
